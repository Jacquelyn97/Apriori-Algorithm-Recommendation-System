/**
 * 自助点餐数据：8 个饮品系列（40 个饮品）+ 小吃及甜品（17 个）
 * 饮品含 description(描述)、taste(口感)、tagline(广告语)。
 */
...
const items = [
  ...
  // 小吃及甜品（小蛋糕/甜甜圈为多口味合并项，点击后到介绍页选口味）
  ...
  { id: 43, name: '薯条', price: 5, categoryId: 'snack', image: 'xc03', taste: '外脆内糯。刚出锅时带着盐粒的微咸，芯里是土豆独有的绵密沙感。', tagline: '热气腾腾的灵魂伴侣，蘸出快乐的咸甜滋味。' },
  {
    ...
    price: 14,
    hasVariants: true,
    taste: '多层次交织。绵软的胚体搭配细腻奶油，果酱的酸甜在舌尖轻盈化开。',
    tagline: '缤纷果漾，是藏在奶油里的五彩幻梦。',
    variants: [
      { id: 'cake_1', name: '樱花龙眼', price: 14, image: 'xc04' },
      { id: 'cake_2', name: '抹茶红豆', price: 14, image: 'xc05' },
      { id: 'cake_3', name: '蓝莓酸奶', price: 14, image: 'xc06' },
      { id: 'cake_4', name: '芒果百香果', price: 14, image: 'xc07' },
      { id: 'cake_5', name: '草莓巧克力', price: 14, image: 'xc08' },
    ],
  },
  ...
  { id: 47, name: '麻薯球', price: 8, categoryId: 'snack', image: 'xc11', taste: 'Q弹软糯。外皮带一点点韧劲，内里湿润有弹性，椰蓉增加了丰富的颗粒感。', tagline: '糯叽叽的内心戏，裹着椰香的可爱暴击。' },
  {
    ...
    price: 9,
    hasVariants: true,
    taste: '扎实松软。面包体蓬松且有嚼劲，覆盖的糖霜与巧克力带来浓郁的甜蜜冲击。',
    tagline: '圆满的甜蜜，圈住生活里所有的美好。',
    variants: [
      { id: 'donut_1', name: '椰子椰奶', price: 9, image: 'xc12' },
      { id: 'donut_2', name: '草莓巧克力', price: 9, image: 'xc13' },
      { id: 'donut_3', name: '草莓樱花', price: 9, image: 'xc14' },
      { id: 'donut_4', name: '草莓椰奶', price: 9, image: 'xc15' },
      { id: 'donut_5', name: '巧克力果仁', price: 9, image: 'xc16' },
      { id: 'donut_6', name: '草莓椰子', price: 9, image: 'xc17' },
    ],
  },
];
